                ...
                <table class="table table-responsive-sm table-bordered">
                  ...
                  <form action="addResvSessionData.php" merhod="post">
                    <tr> 
                      ...
                      <td>
                        <input type="text" name="start_time" id="" required>
                      </td>
                      <td>
                        <input type="text" name="length" id="" required>
                      </td>
                      <td>
                        <input type="text" name="max_capacity" id="" required>
                      </td>
                      <td colspan="3">
...
?>
                  <form action="updateResvSessionData.php">
                    <tr>
                      ...
                      <td><input type="text" name="start_time" value="<?= $resvSessionrRow['start_time']?>" readonly="true" class="dissinputstyle" required></td>
                      <td><input type="text" name="length" value="<?= $resvSessionrRow['length']?>" readonly="true" class="dissinputstyle" required></td>
                      <td><input type="text" name="max_capacity" value="<?= $resvSessionrRow['max_capacity']?>" readonly="true" class="dissinputstyle" required></td>
