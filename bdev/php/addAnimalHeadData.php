...
try {
		require_once("connectg3.php");
			...
			// 動物頭部更新
			$sql = "insert into head (head_no, head_name, head_img ,head_img_combination, head_environment1, head_environment2, head_environment3, head_status, head_ch_name) values (null, :head_name, '', '', :head_environment1, :head_environment2, :head_environment3,:head_status, :head_ch_name)";
